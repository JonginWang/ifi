...
This directory contains tests for IFI database controllers (NasDB and VestDB).
...
pytest tests/db_controller/test_db.py::TestNasDB
pytest tests/db_controller/test_db.py::TestVestDB

# Run specific test method
pytest tests/db_controller/test_db.py::TestNasDB::test_first_call_fetch_and_cache
pytest tests/db_controller/test_db.py::TestVestDB::test_load_shot_data
