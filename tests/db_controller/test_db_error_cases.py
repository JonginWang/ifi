...
def test_nas_db_errors():
    """Test NasDB error handling cases"""
    print("=" * 50)
    print("Testing NasDB Error Cases")
    print("=" * 50)
    ...
    try:
        ...
        print("\n1. Testing normal NasDB initialization...")
        nas_db = NasDB()
        print(f"   [OK] NasDB initialized successfully")
        print(f"   - NAS path: {nas_db.nas_path}")
        print(f"   - Access mode: {nas_db.access_mode}")
        
        # Test 2: Connection test
        print("\n2. Testing NasDB connection...")
        ...
        print(f"   [ERROR] Critical error in NasDB testing: {e}")
        logger.exception("NasDB critical error")

def test_vest_db_errors():
    """Test VestDB error handling cases"""
    print("\n" + "=" * 50)
    print("Testing VestDB Error Cases")
    print("=" * 50)
    ...
    try:
        ...
        # Test 1: Normal initialization
        print("\n1. Testing normal VestDB initialization...")
        vest_db = VestDB()
        print(f"   [OK] VestDB initialized successfully")
        
        # Test 2: Connection test
        print("\n2. Testing VestDB connection...")
        try:
            ...
            print(f"   [ERROR] Error during VestDB connection: {e}")
            logger.exception("VestDB connection error")
            
    except Exception as e:
        print(f"   [ERROR] Critical error in VestDB testing: {e}")
        logger.exception("VestDB critical error")

def test_io_utilserrors():
...
if __name__ == "__main__":
    ...
    # Test NasDB error cases
    test_nas_db_errors()
    
    # Test VestDB error cases  
    test_vest_db_errors()
