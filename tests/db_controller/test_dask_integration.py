...
def test_db_controller_integration():
    ...
    try:
        ...
        print("Testing NasDB initialization...")
        nas_db = NasDB(config_path='ifi/config.ini')
        print("  ✓ NasDB initialized successfully")
        
        # Test VestDB initialization
        print("Testing VestDB initialization...")
        vest_db = VestDB(config_path='ifi/config.ini')
        print("  ✓ VestDB initialized successfully")
        
        # Test connection
        print("Testing NasDB connection...")
        if nas_db.connect():
            print("  ✓ NasDB connected successfully")
            nas_db.disconnect()
        else:
            print("  ✗ NasDB connection failed (may be expected in test environment)")
        
        print("Testing VestDB connection...")
        if vest_db.connect():
            print("  ✓ VestDB connected successfully")
            vest_db.disconnect()
        else:
            print("  ✗ VestDB connection failed (may be expected in test environment)")
