...
ifi_root = current_dir.parent / "ifi"
...
def test_individual_cordic(processor, x, y, target_angles):
...
def test_vectorized_cordic(processor, x, y, target_angles):
...
def test_performance_scaling():
    ...
    for size in sizes:
        ...
        # Test individual
        _, _, time_individual = test_individual_cordic(processor, x, y, target_angles)
        
        # Test vectorized
        _, _, time_vectorized = test_vectorized_cordic(processor, x, y, target_angles)
...
def test_accuracy_with_different_inputs():
    ...
    for name, x, y, target_angles in test_cases:
        ...
        # Individual CORDIC
        mag1, phase1, _ = test_individual_cordic(processor, x, y, target_angles)
        
        # Vectorized CORDIC
        mag2, phase2, _ = test_vectorized_cordic(processor, x, y, target_angles)
...
def main():
    ...
    mag1, phase1, time1 = test_individual_cordic(processor, x, y, target_angles)
    print(f"   Time: {time1:.4f} seconds")
    
    # Test vectorized CORDIC
    print("\n[TEST 2] Vectorized CORDIC operations...")
    mag2, phase2, time2 = test_vectorized_cordic(processor, x, y, target_angles)
