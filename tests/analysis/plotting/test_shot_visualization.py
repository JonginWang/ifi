...
def test_spectrum_plots(logger):
    ...
    try:
        ...
        fig, ax = plotter.plot_time_frequency(
...
def test_real_shot_visualization(logger, shot_num=45821):
    ...
    results_dir = ensure_dir_exists("ifi/results/test_shot_vis") / f"{shot_num}"
    ...
    try:
        ...
        plotter.plot_shot_overview(shot_data, vest_data, shot_num, save_path=results_dir / f"{shot_num}_overview.png")
