...
def test_standalone_function():
    """Test the standalone assign_interferometry_params_to_shot function."""
    print("Testing assign_interferometry_params_to_shot function:")
    print("=" * 60)
    ...
    for shot_num, filename, expected in test_cases:
        params = assign_interferometry_params_to_shot(shot_num, filename)
...
def test_numba_optimization():
    ...
    try:
        from ifi.analysis.phi2ne import normalize_iq_signals_jit, calculate_differential_phase_jit
        ...
        i_norm, q_norm = normalize_iq_signals_jit(i_signal.real, q_signal.real)
        print("normalize_iq_signals_jit executed successfully")
        
        phase_diff = calculate_differential_phase_jit(i_norm, q_norm)
        print("calculate_differential_phase_jit executed successfully")
