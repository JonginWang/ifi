...
def test_phase_analysis_errors():
    ...
    try:
        ...
        try:
            ...
            print("\t[WARN] PhaseChangeDetector with negative fs succeeded")
        except Exception as e:
...
def test_spectrum_analysis_errors():
    ...
    try:
        ...
        print("\t[OK] SpectrumAnalysis initialized successfully")
        ...
        try:
            ...
            result = analyzer.compute_stft(np.sin(2 * np.pi * 10 * np.linspace(0, 1, 1000)), 
                                        window_size=0)
            print("\t[WARN] Invalid window size processing succeeded")
        except Exception as e:
        ...
        try:
            ...
            print("\t[WARN] Empty signal processing succeeded")
        except Exception as e:
        ...
        try:
            ...
            print("\t[WARN] Single sample signal processing succeeded")
        except Exception as e:
        ...
        try:
            ...
            print("\t[WARN] NaN values processing succeeded")
        except Exception as e:
        ...
        try:
            ...
            print("\t[WARN] Inf values processing succeeded")
        except Exception as e:
...
def test_plotting_errors():
    ...
    try:
        ...
        plotter = Plotter()
        print("\t[OK] Plotter initialized successfully")
        ...
        try:
            ...
            print("\t[WARN] Empty DataFrame plotting succeeded")
        except Exception as e:
        ...
        try:
            ...
            print("\t[WARN] Non-numeric DataFrame plotting succeeded")
        except Exception as e:
        ...
        try:
            ...
            print("\t[WARN] All NaN DataFrame plotting succeeded")
        except Exception as e:
        ...
        try:
            ...
            print("\t[WARN] Invalid time-frequency data plotting succeeded")
        except Exception as e:
        ...
        try:
            ...
            print("\t[WARN] None data plotting succeeded")
        except Exception as e:
...
def test_main_analysis_errors():
    ...
    try:
        ...
        try:
            ...
            print("\t[WARN] None arguments processing succeeded")
        except Exception as e:
        ...
        try:
            ...
            print("\t[WARN] Invalid file paths processing succeeded")
        except Exception as e:
        ...
        try:
            ...
            args = MockArgs()
            result = run_analysis(args)
            print("\t[WARN] Empty data folders processing succeeded")
        except Exception as e:
        ...
        try:
            ...
            args = MockArgs()
            result = run_analysis(args)
            print("\t[WARN] Invalid scheduler processing succeeded")
        except Exception as e:
