...
from ifi.analysis.phi2ne import PhaseConverter, normalize_iq_signals_jit, calculate_differential_phase_jit, accumulate_phase_diff_jit, phase_to_density_jit
...
class PerformanceTester:
    ...
    def test_numba_functions(self):
        ...
        time_norm, (i_norm, q_norm) = self.benchmark_function(
            normalize_iq_signals_jit, i_signal, q_signal,
        ...
        time_diff, phase_diff = self.benchmark_function(
            calculate_differential_phase_jit, i_norm, q_norm,
        ...
        time_cumsum, phase_accum = self.benchmark_function(
            accumulate_phase_diff_jit, phase_diff,
        ...
        time_density, density = self.benchmark_function(
            phase_to_density_jit, phase_test, freq, c, m_e, eps0, qe, n_path,
    ...
    def test_jit_compilation_effect(self):
        ...
        for i in range(10):
            ...
            # Full pipeline
            i_norm, q_norm = normalize_iq_signals_jit(i_signal, q_signal)
