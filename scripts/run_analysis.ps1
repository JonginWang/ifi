...
if ($Help) {
    ...
    Write-Host "  .\run_analysis.ps1 45821 --cwt --envelope"
    Write-Host "  .\run_analysis.ps1 45821 --cwt --plot_envelope --plot"
...
# Run analysis
$Command = "python -m ifi.analysis.ifi_analyzer --query $query $($ArgsList -join ' ')"
