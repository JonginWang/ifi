...
if "!MODE!"=="signal-only" (
    ...
    python -m ifi.analysis.ifi_analyzer --query !QUERY! --stft --save_data --scheduler !SCHEDULER! !ARGS!
) else if "!MODE!"=="density" (
    REM Full analysis: STFT + density, save data
    python -m ifi.analysis.ifi_analyzer --query !QUERY! --stft --density --save_data --scheduler !SCHEDULER! !ARGS!
) else (
