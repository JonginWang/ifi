...
Tests both standalone function and class methods, including the new
...
def test_standalone_function():
    ...
    for shot_num, filename, expected in test_cases:
        ...
        print(f"   {'✅' if freq_match else '❌'} Frequency consistency: {freq_match}")
        print()
...
def test_phase_to_density_integration():
    ...
    for shot_num, filename, description in test_cases:
        ...
        try:
            ...
            print(f"   {'✅' if consistency else '❌'} Results consistency: {consistency}")
