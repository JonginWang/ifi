...
"""
    ...
    Functions:
        remezord: Filter parameter selection for the Remez exchange algorithm.
            - Inputs:
                - freqs: A monotonic sequence of band edges specified in Hertz. All elements must be non-negative and less than 1/2 the sampling frequency as given by the Hz parameter.
                - amps: A sequence containing the amplitudes of the signal to be filtered over the various bands.
                - rips: A sequence specifying the maximum ripples of each band. 
                - Hz: Sampling frequency in Hertz.
                - alg: Filter length approximation algorithm. May be 'herrmann', 'kaiser', or 'ichige'.
