...
ridge_idxs, *_ = extract_ridges(test_matrix, fs_test, penalty=2.0, get_params=True)
...
x2 = sig.chirp(t, f0=0.4, f1=4, t1=20, method="quadratic")
x = x1 + x2
...
tf_transforms(
    x, t, n_ridges=3, padtype=padtype, stft_bw=4, ssq_stft_bw=4, penalty=penalty
)
